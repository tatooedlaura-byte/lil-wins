...
// Graveyard starter template - fully populated haunted cemetery
const graveyardTemplate = [
    // ===== CENTER - Main Crypt =====
    { q: 0, r: 0, tile: 'floor_dirt_grave', building: 'crypt' },

    // ===== RING 1 - Inner graveyard circle =====
    { q: 1, r: 0, tile: 'floor_dirt', building: 'grave_A' },
    { q: 0, r: 1, tile: 'floor_dirt', building: 'gravestone' },
    { q: -1, r: 1, tile: 'floor_dirt', building: 'grave_B' },
    { q: -1, r: 0, tile: 'floor_dirt', building: 'candle_triple' },
    { q: 0, r: -1, tile: 'floor_dirt', building: 'grave_A' },
    { q: 1, r: -1, tile: 'floor_dirt', building: 'gravemarker_A' },

    // ===== RING 2 - Graves, coffins, and decor =====
    { q: 2, r: 0, tile: 'floor_dirt', building: 'coffin' },
    { q: 1, r: 1, tile: 'floor_dirt', building: 'lantern_standing' },
    { q: -1, r: 2, tile: 'floor_dirt', building: 'grave_A' },
    { q: -2, r: 1, tile: 'floor_dirt', building: 'shrine' },
    { q: -2, r: 0, tile: 'floor_dirt', building: 'grave_B' },
    { q: -1, r: -1, tile: 'floor_dirt', building: 'skull_candle' },
    { q: 0, r: -2, tile: 'floor_dirt', building: 'gravemarker_B' },
    { q: 1, r: -2, tile: 'floor_dirt', building: 'coffin_decorated' },
    { q: 2, r: -2, tile: 'floor_dirt', building: 'grave_A' },
    { q: 2, r: -1, tile: 'floor_dirt', building: 'pumpkin_jacko' },
    { q: 0, r: 2, tile: 'floor_dirt', building: 'bench_decorated' },
    { q: -2, r: 2, tile: 'floor_dirt', building: 'post_skull' },

    // ===== RING 3 - Fence perimeter with gates =====
    { q: 3, r: 0, tile: 'floor_dirt', building: 'fence_gate' },
    { q: 3, r: -1, tile: 'floor_dirt', building: 'fence' },
    { q: 3, r: -2, tile: 'floor_dirt', building: 'tree_dead_large' },
    { q: 3, r: -3, tile: 'floor_dirt', building: 'fence_pillar' },
    { q: 2, r: 1, tile: 'floor_dirt', building: 'fence' },
    { q: 1, r: 2, tile: 'floor_dirt', building: 'tree_dead_medium' },
    { q: 0, r: 3, tile: 'floor_dirt', building: 'arch_gate' },
    { q: -1, r: 3, tile: 'floor_dirt', building: 'fence' },
    { q: -2, r: 3, tile: 'floor_dirt', building: 'tree_pine_orange' },
    { q: -3, r: 3, tile: 'floor_dirt', building: 'fence_pillar' },
    { q: -3, r: 2, tile: 'floor_dirt', building: 'fence' },
    { q: -3, r: 1, tile: 'floor_dirt', building: 'tree_dead_small' },
    { q: -3, r: 0, tile: 'floor_dirt', building: 'shrine_candles' },
    { q: -2, r: -1, tile: 'floor_dirt', building: 'fence' },
    { q: -1, r: -2, tile: 'floor_dirt', building: 'fence_pillar' },
    { q: 0, r: -3, tile: 'floor_dirt', building: 'arch' },
    { q: 1, r: -3, tile: 'floor_dirt', building: 'fence' },
    { q: 2, r: -3, tile: 'floor_dirt', building: 'cauldron' },

    // ===== RING 4 - Outer graveyard with trees and pumpkins =====
    { q: 4, r: 0, tile: 'floor_dirt', building: 'tree_dead_large_decorated' },
    { q: 4, r: -1, tile: 'floor_dirt', building: 'grave_A' },
    { q: 4, r: -2, tile: 'floor_dirt', building: 'pumpkin_jacko' },
    { q: 4, r: -3, tile: 'floor_dirt', building: 'gravestone' },
    { q: 4, r: -4, tile: 'floor_dirt', building: 'tree_pine_yellow' },
    { q: 3, r: 1, tile: 'floor_dirt', building: 'grave_B' },
    { q: 2, r: 2, tile: 'floor_dirt', building: 'lantern_standing' },
    { q: 1, r: 3, tile: 'floor_dirt', building: 'gravemarker_A' },
    { q: 0, r: 4, tile: 'floor_dirt', building: 'post_lantern' },
    { q: -1, r: 4, tile: 'floor_dirt', building: 'grave_A' },
    { q: -2, r: 4, tile: 'floor_dirt', building: 'pumpkin_yellow' },
    { q: -3, r: 4, tile: 'floor_dirt', building: 'coffin' },
    { q: -4, r: 4, tile: 'floor_dirt', building: 'tree_dead_medium' },
    { q: -4, r: 3, tile: 'floor_dirt', building: 'jackolantern_big' },
    ...
    { q: 1, r: -4, tile: 'floor_dirt', building: 'skull_candle' },
    { q: 2, r: -4, tile: 'floor_dirt', building: 'tree_dead_small' },
    { q: 3, r: -4, tile: 'floor_dirt', building: 'grave_A' },

    // ===== RING 5 - Spooky forest border =====
    { q: 5, r: 0, tile: 'floor_dirt', building: 'tree_dead_large' },
    { q: 5, r: -1, tile: 'floor_dirt', building: 'pumpkin_orange' },
    { q: 5, r: -2, tile: 'floor_dirt', building: 'tree_pine_orange' },
    { q: 5, r: -3, tile: 'floor_dirt', building: 'candyBucket' },
    { q: 5, r: -4, tile: 'floor_dirt', building: 'tree_dead_medium' },
    { q: 5, r: -5, tile: 'floor_dirt', building: 'jackolantern_big' },
    { q: 4, r: 1, tile: 'floor_dirt', building: 'tree_pine_yellow' },
    { q: 3, r: 2, tile: 'floor_dirt', building: 'grave_B' },
    { q: 2, r: 3, tile: 'floor_dirt', building: 'tree_dead_small' },
    { q: 1, r: 4, tile: 'floor_dirt', building: 'bench' },
    { q: 0, r: 5, tile: 'floor_dirt', building: 'tree_dead_large_decorated' },
    { q: -1, r: 5, tile: 'floor_dirt', building: 'pumpkin_jacko' },
    { q: -2, r: 5, tile: 'floor_dirt', building: 'tree_pine_orange' },
    { q: -3, r: 5, tile: 'floor_dirt', building: 'lantern_standing' },
    { q: -4, r: 5, tile: 'floor_dirt', building: 'tree_dead_medium' },
    { q: -5, r: 5, tile: 'floor_dirt', building: 'coffin_decorated' },
    { q: -5, r: 4, tile: 'floor_dirt', building: 'tree_pine_yellow' },
    { q: -5, r: 3, tile: 'floor_dirt', building: 'grave_A' },
    { q: -5, r: 2, tile: 'floor_dirt', building: 'tree_dead_large' },
    { q: -5, r: 1, tile: 'floor_dirt', building: 'pumpkin_yellow' },
    { q: -5, r: 0, tile: 'floor_dirt', building: 'tree_pine_orange' },
    { q: -4, r: -1, tile: 'floor_dirt', building: 'gravestone' },
    { q: -3, r: -2, tile: 'floor_dirt', building: 'tree_dead_small' },
    { q: -2, r: -3, tile: 'floor_dirt', building: 'bone_B' },
    { q: -1, r: -4, tile: 'floor_dirt', building: 'tree_pine_yellow' },
    { q: 0, r: -5, tile: 'floor_dirt', building: 'arch_gate' },
    { q: 1, r: -5, tile: 'floor_dirt', building: 'tree_dead_medium' },
    { q: 2, r: -5, tile: 'floor_dirt', building: 'pumpkin_jacko' },
    { q: 3, r: -5, tile: 'floor_dirt', building: 'tree_pine_orange' },
    { q: 4, r: -5, tile: 'floor_dirt', building: 'post_skull' },
];
...
class Graveyard {
    ...
    init() {
        ...
        // Orange accent light (like from jack-o-lanterns)
        const pumpkinLight = new THREE.PointLight(0xff6600, 0.5, 20);
